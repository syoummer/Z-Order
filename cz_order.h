...
/**
 * CPU implementation of Z-order calculation
 * works on 32-bit int
 **/

const unsigned short cdilate_tab2[256] = {
...
/*  Algorithm 1  */
inline unsigned int cdilate_2(unsigned short x) {
  return cdilate_tab2[    0xFF & x      ]
      | (cdilate_tab2[ (0xFFFF & x) >>8 ] <<16);
}

inline unsigned int cz_order(unsigned short x, unsigned short y)
{
	return 2*cdilate_2(y)+cdilate_2(x);
}

const unsigned char cundilate_tab2[256] = {
...
/*  Algorithm 2  */
inline unsigned short cundilate_2(unsigned int x) {
  return cundilate_tab2[0xFF & ((x>>7) |x)      ]
      | (cundilate_tab2[0xFF &(((x>>7) |x) >>16)]
           << 8);
}

inline unsigned short cz_order_x(unsigned int index) {
	return cundilate_2(index&0x55555555);
}

inline unsigned short cz_order_y(unsigned int index) {
	return cundilate_2((index>>1)&0x55555555);
}
